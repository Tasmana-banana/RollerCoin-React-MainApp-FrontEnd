...
const TaskWallLeaderboardRulesWeekly = () => {
	const { t } = useTranslation("FAQ");
	const content = t("faqCards.taskWallLeaderboardRulesWeekly", { returnObjects: true });
	return (
...
export default TaskWallLeaderboardRulesWeekly;
