...
const TaskWallLeaderboardRulesGrand = () => {
	const { t } = useTranslation("FAQ");
	const content = t("faqCards.taskWallLeaderboardRulesGrand", { returnObjects: true });
	return (
...
export default TaskWallLeaderboardRulesGrand;
