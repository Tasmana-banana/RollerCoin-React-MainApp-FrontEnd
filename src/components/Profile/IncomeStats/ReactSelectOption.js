...
const ReactSelectOption = (props) => (
	<Option {...props} className="react-select-option-with-image">
		<div>
			<LazyLoad offset={100}>
				<img src={`/static/img/wallet/${props.data.value}.svg?v=1.13`} alt={props.data.value} />
			</LazyLoad>
...
const ReactSelectValue = ({ children, ...props }) => (
	<ValueContainer {...props} className="react-select-option-with-image">
		<div>
			<LazyLoad offset={100}>
				<img src={`/static/img/wallet/${props.selectProps.value.value}.svg?v=1.13`} alt={props.selectProps.value.value} />
			</LazyLoad>
