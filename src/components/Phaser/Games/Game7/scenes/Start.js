...
export default class Start extends Scene {
	...
	create() {
		...
		const spriteControlsName = this.game.device.touch ? "controls_mobile" : "controls";
		this.controlSprite = this.add.sprite(this.game.config.width / 2, 390, spriteControlsName);
		this.controlSprite.setOrigin(0.5);
	}
